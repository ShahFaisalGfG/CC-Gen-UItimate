<#
.SYNOPSIS
    Build the CC-Gen-Ultimate system-wide Windows installer.
.DESCRIPTION
...
$Entry   = "app.py"
$IssFile = "installer\ccgenultimate_system_installer.iss"
...
if (-not (Test-Path $ShellDll)) {
    Fail "ccgen_shell.dll not found at: $ShellDll - run build_native.ps1 first."
}
